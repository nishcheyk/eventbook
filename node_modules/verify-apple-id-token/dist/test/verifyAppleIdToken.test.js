...
describe("Verify Apple idToken", function () {
    ...
    it("The `iss` field is not valid", function () { return __awaiter(void 0, void 0, void 0, function () {
        var idToken, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it("The `header.alg` field is not valid", function () { return __awaiter(void 0, void 0, void 0, function () {
        var idToken, decoded, kid, publicKey, modifiedToken, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    ...
                    return [4 /*yield*/, (0, index_1.getApplePublicKey)(kid)];
                case 1:
                    publicKey = _a.sent();
                    modifiedToken = jwt.sign(decoded.payload, publicKey, { algorithm: "HS256", keyid: kid });
                    return [4 /*yield*/, (0, index_1.default)({ idToken: modifiedToken, clientId: "test" })];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    error_3 = _a.sent();
                    return [2 /*return*/, expect(error_3.message).toMatch(/The alg does not match the jwk configuration - alg: HS256 | expected: RS256/)];
    ...
    it("Token is expired", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_4 = _a.sent();
                    return [2 /*return*/, expect(error_4.message).toMatch(/jwt expired/)];
                case 3: throw new Error("Expected to throw");
            }
        });
    }); });
    it("Nonce is not valid", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_5 = _a.sent();
                    return [2 /*return*/, expect(error_5.message).toMatch(/jwt nonce invalid/)];
                case 3: throw new Error("Expected to throw");
            }
        });
    }); });
